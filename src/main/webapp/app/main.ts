...
import ImplementationModelService from '@/entities/implementation-model/implementation-model.service';
...
new Vue({
  ...
  provide: {
    ...
    implementationModelService: () => new ImplementationModelService(),
